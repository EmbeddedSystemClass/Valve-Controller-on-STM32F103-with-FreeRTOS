...
/****************************************************************************/
void HAL_UART_SEND_BYTE( BYTE data);
BYTE HAL_UART_REC_BYTE(void);
...
//#define ZW_UART_REC_STATUS      ha(UART1_FLAG_RXNE)

#define ZW_UART_SEND_BYTE(i)    HAL_UART_SEND_BYTE(i)
#define ZW_UART_WAIT_RECEIVE
#define ZW_UART_REC_BYTE        HAL_UART_REC_BYTE()
#define ZW_UART_REC_STATUS      __HAL_UART_GET_FLAG(&huart5, UART_FLAG_RXNE)
