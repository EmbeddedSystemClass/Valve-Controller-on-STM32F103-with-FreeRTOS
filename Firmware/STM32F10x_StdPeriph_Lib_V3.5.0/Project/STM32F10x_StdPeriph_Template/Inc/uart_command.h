...
#define ZW_UART_SEND_BYTE(i)    USART_SendData(UART5,i);
#define ZW_UART_WAIT_RECEIVE    while(USART_GetFlagStatus(UART5,USART_FLAG_RXNE) == RESET);
#define ZW_UART_REC_BYTE        USART_ReceiveData(UART5);
#define ZW_UART_REC_STATUS      USART_GetFlagStatus(UART5,USART_FLAG_RXNE)
